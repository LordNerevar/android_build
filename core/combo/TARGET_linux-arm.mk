...
TARGET_GCC_VERSION := 5.x
else
TARGET_GCC_VERSION := $(TARGET_GCC_VERSION_EXP)
endif

ifeq ($(strip $(TARGET_KERNEL_GCC_VERSION_EXP)),)
TARGET_KERNEL_GCC_VERSION := 5.x
else
...
TARGET_arm_CFLAGS := $(ARCHIDROID_GCC_CFLAGS_ARM) \
	-fomit-frame-pointer \
	-fstrict-aliasing \
	-funswitch-loops
...
ifneq ($(filter 4.6 4.6.% 4.7 4.7.% 4.8 4.8.% 4.9 4.9.% 5.%, $(TARGET_GCC_VERSION)),)
